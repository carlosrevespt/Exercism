...
public class TriangleTests
{
    ...
    [Fact]
    public void Degenerate_triangle_side1_side2()
    {
        Assert.True(Triangle.IsDegenerate(2, 2, 4));
    }

    [Fact]
    public void Degenerate_triangle_side1_side3()
    {
        Assert.True(Triangle.IsDegenerate(2, 4, 2));
    }

    [Fact]
    public void Degenerate_triangle_side2_side3()
    {
        Assert.True(Triangle.IsDegenerate(4, 2, 2));
    }

    [Fact]
    public void Degenerate_triangle_not_isosceles()
    {
        Assert.False(Triangle.IsIsosceles(2, 2, 4));
    }
}